    ...
    return (
        <section className="flex flex-col px-[3rem] sm:px-[10rem] pt-[7rem] sm:pt-[13rem] relative pb-[6rem] sm:pb-[15rem] overflow-hidden">
            <div className="">
                ...
                <Image className="absolute sm:block hidden right-[10rem] top-[6.5rem] w-[20rem] h-[45rem] rotate-[-5deg]" width={260} height={576} src='/hero_icon_bg_2.png' alt="icon" />
                ...
                <Image className="absolute hidden sm:block bottom-[25rem] left-[22rem] h-[10rem]" width={155} height={122} src='/convex.svg' alt="icon" />
                ...
                <Image className="absolute left-[1rem] sm:left-[11rem] sm:bottom-[19rem] bottom-[8rem] w-[7rem] sm:w-[15rem] sm:h-[12rem] h-[8rem] " width={71} height={139} src='/hero_icon_sm_3.svg' alt="icon" />
