...
const Index = () => {
    ...
    return (
        <section className="flex z-[10] flex-col px-[3rem] sm:px-[10rem] pt-[13rem] sm:pt-[23rem] relative pb-[6rem] sm:pb-[15rem] overflow-hidden">
            <div className="">
                ...
                <Image className="absolute right-[.6rem] top-[13rem] w-[7rem] h-[13rem] rotate-[-5deg] sm:hidden" width={71} height={139} src='/rabbitMQ_hero-R.png' alt="icon" />
                ...
                <Image data-animation-id='fadeIn' className="absolute left-[2rem] sm:left-[11rem] sm:bottom-[19rem] bottom-[8rem] w-[5.5rem] sm:w-[15rem] sm:h-[12rem] h-[8rem] " width={71} height={139} src='/hero_icon_sm_3.svg' alt="icon" />
