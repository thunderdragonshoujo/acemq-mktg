...
import tech1Img from "@/images/tech_1.svg";
import tech2Img from "@/images/tech_2.svg";
import tech3Img from "@/images/tech_3.svg";
import tech4Img from "@/images/tech_4.svg";
import tech5Img from "@/images/tech_5.svg";
import tech6Img from "@/images/tech_6.svg";
import tech7Img from "@/images/tech_7.svg";
...
const Features = () => {
  return (
    <div className="mb-[4rem] flex flex-col">
      <h3 className="sub-header text-center sm:mb-[6rem] mb-[3rem]">
        <span className="text-[#8FD5CC]">Features</span> and Benefits
      </h3>
      <img
        src="/service_features.webp"
        className="hidden sm:block"
        alt="features"
      />
      <img
        src="/service_features_sm.svg"
        className="sm:hidden"
        alt="features"
      />

      <h4 className="font-[700] sm:text-[5rem] text-center hidden sm:block mt-[8rem]">
        <span className="text-[#8FD5CC]">The</span> AceMQ{" "}
        <span className="font-[400]">Assurance</span>
      </h4>
      <p className="text-center mt-[1rem] w-[65%] hidden sm:block self-center">
        ...
        cost-effective solution compared to the expenses associated with hiring
        expert talent
      </p>
    </div>
  );
