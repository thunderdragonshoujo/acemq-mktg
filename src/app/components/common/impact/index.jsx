...
import customerStory from "@/images/customer_story.webp";
import customerStory2 from "@/images/customer_story2.webp";
const Index = () => {
  const cards = [
    {
