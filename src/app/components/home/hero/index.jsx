...
const Index = () => {
    ...
    return (
        <section className="relative bg-black sm:pl-[10rem] sm:pr-[0] px-[2.5rem]">

            <MaxContainer>
                <div className=" z-[0] pb-[2rem] sm:pb-[8rem] pt-[6.3rem] relative">
                    ...
                    <div className="relative flex gap-[4rem]">
                        <div className="h-[0] overflow-hidden z-[-1] absolute hidden sm:block" data-animation-id='milestone'>
