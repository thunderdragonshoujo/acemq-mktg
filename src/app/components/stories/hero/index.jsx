...
const Index = () => {
    return (
        <section className="py-[5.5rem] sm:pt-[17rem] sm:pb-[18rem] px-[1.5rem] sm:px-[10rem] relative">
            ...
            <div className="flex flex-col items-center relative">
               <h1 className="header">Customer <span className="text-[#8FD5CC]">Stories</span></h1>
            </div>
        </section>
    );
}
