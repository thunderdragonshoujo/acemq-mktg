    ...
    return (
        <div className="sm:flex sm:flex-row-reverse sm:justify-between sm:mb-[10rem] mb-[5rem]">
            <div className="sm:w-[48rem]">
                <h2 className="sub-header text-center sm:text-left"><span className="font-[400] px-[2rem] py-[1rem] bg-[#8FD5CC] text-[#232323] rounded-[2rem]">Our</span><br></br> Services</h2>
            ...
            <Image src='/flow.webp' className="mt-[2rem]" width={700} height={400} alt="" />
        </div>
    )
}
    ...
    return (
        <div className="">
            <div className="flex justify-between">
                <Image width={640} height={440} src='MQ_service_1.svg' alt="service" />
                <Image width={730} className="hidden sm:block" height={350} src='MQ_service_1_flowchart.svg' alt="service" />
            </div>
            <div className="flex justify-between flex-row-reverse">
                <Image width={640} height={440} src='MQ_service_2.svg' alt="service" />
...
const Values = () => {
    return (
        <div className="sm:mt-[10rem] mt-[5rem] flex flex-col items-center">
            ...
            <Image width={1150} height={480} src='/values.svg' alt="values" />
        </div>
    )
}
...
const Assesment = () => {
    return (
        <div className="flex flex-col items-center sm:mt-[10rem] mt-[5rem]">
            ...
            <h4 className="sub-header sm:hidden text-center w-[20rem]"><span className="font-[400]">Consulting</span> & Assessment</h4>
...
const Support = () => {
    return (
        <div className="mt-[5rem]">
            <PlaceTextBesideImage header={<h4 className="sub-header text-center"><span className="text-[#8FD5CC]">Support</span> & Services</h4>} firstParagraph={'Managed Service:  Fully managed message broker environment and services, providing peace of mind and freeing up your team\'s resources.'} secondParagraph={'Comprehensive Support:  This includes to operations and oversight including dedicated resources and service level agreements (SLAs)'} imageWidth={'hidden sm:block'} thirdParagraph={'Comprehensive support:  Tailored solutions addressing your environment and business demands, covering troubleshooting, deployments, operations, and sustainment. This includes dedicated resources and service level agreements (SLAs).'} image={'/MQ_service_board.png'} subHeader={' Our support offerings include:'} />
        </div>
    )
}