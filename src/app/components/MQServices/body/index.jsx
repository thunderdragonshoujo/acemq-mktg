...
const Services = () => {
    return (
        <div className="sm:flex sm:flex-row-reverse sm:justify-between sm:mb-[10rem] mb-[5rem]" data-animation-id='slideIn'>
            ...
            <Image src='/flow.webp' className="mt-[2rem] border hidden sm:block sm:w-[70rem] self-start" width={700} height={400} alt="flow chat" />
            <Image src='/messaging_products.png' className="mt-[2rem] sm:w-[70rem] self-start" width={700} height={400} alt="flow chat" />
        </div>
    )
}
    ...
    return (
        <div className="" data-animation-id='slideIn'>
            <div className="flex justify-between mb-[3rem]">
                <Image width={640} className="w-[60rem] hidden sm:block" height={440} src='/MQ_service_1.svg' alt="service" />
            ...
            <div className="flex justify-between flex-row-reverse">
                ...
                {/* <Image width={640} height={440} className="sm:blo w-[60rem] border sm:mt-[10rem]" src='/MQ_service_2.svg' alt="service" /> */}
...
const Values = () => {
    return (
        <div className="sm:mt-[10rem] mt-[5rem] flex flex-col items-center" data-animation-id='slideIn'>
            ...
            <Image width={1150} height={700} src='/troubleshooting_sm.png' className="sm:hidden" alt="values" />
        </div>
    )
}
